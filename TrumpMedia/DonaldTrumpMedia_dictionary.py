...
Trump_dictionary = {
	'donald trump': ['trump', 'donald', 'president trump', 'president donald trump',
		'mr trump', 'trumps', 'trumpm organization', 'donal j trump']
	'trump administration': ['senior trump administration officials', 'the white house',
		...
		'white house source', 'administraiton officials']
	...
	'mitch mcconnell': ['senate majority leader mitch mcconnell', 'mcconnel', 'senator mitch mcconnell',
	...
	'brett kavanaugh': ['kavanaugh', 'supreme court pick', 'supreme court nominee', 'judge brett m kavanaugh',
		...
		'judge kavanaugh', 'supreme court nominee brett kavanaugh', 'brett', 'judege brett kavanaugh']
	'brett kavanaugh accuser': ['deborah ramirez', 'christine blasety ford', 'charles ludington',
		'julie swetnick']
	...
	'john podestra': ['hilary clintons campaign chairman', 'podestra']
	'julian assange': ['wikileaks founder julian assange', 'assange']
	'robert mueller': ['muellerller', 'special prosecutor']	
	...
	'chinese media': ['chinese-languate newspaper']	
	...
	'immigrant detention': ['prosecuting undocumented migrants', 'childred being held in jail', 
	...
	'capital expediture': ['capex', 'capital investment']
	'economic growth': ['recovery', 'cyclical upswing']
	'economic supression': ['financial crisis', 'downturn', 'recession', 'market disruption'
		'weaker growth']
	'gross domestic product': ['gdp', 'gdp rate', 'gdp growth']
	'unemployment': ['umemployment rate', 'manufacturing jobs', 'jobless numbers',
